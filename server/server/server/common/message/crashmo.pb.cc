...
const ::google::protobuf::Descriptor* MsgAddOfficilMapACK_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  MsgAddOfficilMapACK_reflection_ = NULL;
...
void protobuf_AssignDesc_crashmo_2eproto() {
  ...
  MsgOfficilMapACK_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1);
  MsgAddOfficilMapACK_descriptor_ = file->message_type(7);
  static const int MsgAddOfficilMapACK_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgAddOfficilMapACK, map_),
  };
  MsgAddOfficilMapACK_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      MsgAddOfficilMapACK_descriptor_,
      MsgAddOfficilMapACK::default_instance_,
      MsgAddOfficilMapACK_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgAddOfficilMapACK, _has_bits_[0]),
      -1,
      -1,
      sizeof(MsgAddOfficilMapACK),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgAddOfficilMapACK, _internal_metadata_),
      -1);
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      MsgAddOfficilMapACK_descriptor_, &MsgAddOfficilMapACK::default_instance());
}
...
void protobuf_ShutdownFile_crashmo_2eproto() {
  ...
  delete MsgAddOfficilMapACK::default_instance_;
  delete MsgAddOfficilMapACK_reflection_;
}
...
void protobuf_AddDesc_crashmo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "rashMapData\"9\n\023MsgAddOfficilMapACK\022\"\n\003ma"
    "p\030\001 \002(\0132\025.message.CrashMapData*\177\n\013Server"
    "Error\022\022\n\016ServerError_NO\020\000\022\026\n\022ServerError"
    "_Unknow\020\001\022\034\n\030ServerError_HaveSameName\020\002\022"
    "&\n\"ServerError_NotFoundMapNameWhenDel\020\003*"
    "<\n\007MapType\022\r\n\tOfficeMap\020\001\022\021\n\rImcompleteM"
    "ap\020\002\022\017\n\013CompleteMap\020\003", 861);
  ...
  MsgAddOfficilMapACK::default_instance_ = new MsgAddOfficilMapACK();
  ...
  MsgAddOfficilMapACK::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int MsgAddOfficilMapACK::kMapFieldNumber;
#endif  // !_MSC_VER

MsgAddOfficilMapACK::MsgAddOfficilMapACK()
  : ::google::protobuf::Message() , _internal_metadata_(NULL)  {
  SharedCtor();
  // @@protoc_insertion_point(constructor:message.MsgAddOfficilMapACK)
}

void MsgAddOfficilMapACK::InitAsDefaultInstance() {
  map_ = const_cast< ::message::CrashMapData*>(&::message::CrashMapData::default_instance());
}

MsgAddOfficilMapACK::MsgAddOfficilMapACK(const MsgAddOfficilMapACK& from)
  : ::google::protobuf::Message(),
    _internal_metadata_(NULL) {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:message.MsgAddOfficilMapACK)
}

void MsgAddOfficilMapACK::SharedCtor() {
  _cached_size_ = 0;
  map_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
MsgAddOfficilMapACK::~MsgAddOfficilMapACK() {
  // @@protoc_insertion_point(destructor:message.MsgAddOfficilMapACK)
  SharedDtor();
}

void MsgAddOfficilMapACK::SharedDtor() {
  if (this != default_instance_) {
    delete map_;
  }
}

void MsgAddOfficilMapACK::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* MsgAddOfficilMapACK::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return MsgAddOfficilMapACK_descriptor_;
}

const MsgAddOfficilMapACK& MsgAddOfficilMapACK::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_crashmo_2eproto();
  return *default_instance_;
}

MsgAddOfficilMapACK* MsgAddOfficilMapACK::default_instance_ = NULL;

MsgAddOfficilMapACK* MsgAddOfficilMapACK::New(::google::protobuf::Arena* arena) const {
  MsgAddOfficilMapACK* n = new MsgAddOfficilMapACK;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void MsgAddOfficilMapACK::Clear() {
  if (has_map()) {
    if (map_ != NULL) map_->::message::CrashMapData::Clear();
  }
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
bool MsgAddOfficilMapACK::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:message.MsgAddOfficilMapACK)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:message.MsgAddOfficilMapACK)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:message.MsgAddOfficilMapACK)
  return false;
#undef DO_
}

void MsgAddOfficilMapACK::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:message.MsgAddOfficilMapACK)
  // required .message.CrashMapData map = 1;
  if (has_map()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, *this->map_, output);
  ...
  // @@protoc_insertion_point(serialize_end:message.MsgAddOfficilMapACK)
}

::google::protobuf::uint8* MsgAddOfficilMapACK::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:message.MsgAddOfficilMapACK)
  // required .message.CrashMapData map = 1;
  if (has_map()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.MsgAddOfficilMapACK)
  return target;
}

int MsgAddOfficilMapACK::ByteSize() const {
  int total_size = 0;
...
void MsgAddOfficilMapACK::MergeFrom(const ::google::protobuf::Message& from) {
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const MsgAddOfficilMapACK* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const MsgAddOfficilMapACK*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void MsgAddOfficilMapACK::MergeFrom(const MsgAddOfficilMapACK& from) {
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_map()) {
      mutable_map()->::message::CrashMapData::MergeFrom(from.map());
...
void MsgAddOfficilMapACK::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void MsgAddOfficilMapACK::CopyFrom(const MsgAddOfficilMapACK& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool MsgAddOfficilMapACK::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;
...
void MsgAddOfficilMapACK::Swap(MsgAddOfficilMapACK* other) {
  if (other == this) return;
  InternalSwap(other);
}
void MsgAddOfficilMapACK::InternalSwap(MsgAddOfficilMapACK* other) {
  std::swap(map_, other->map_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
...
::google::protobuf::Metadata MsgAddOfficilMapACK::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = MsgAddOfficilMapACK_descriptor_;
  metadata.reflection = MsgAddOfficilMapACK_reflection_;
  return metadata;
}
...
// required .message.CrashMapData map = 1;
 bool MsgAddOfficilMapACK::has_map() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
 void MsgAddOfficilMapACK::set_has_map() {
  _has_bits_[0] |= 0x00000001u;
}
 void MsgAddOfficilMapACK::clear_has_map() {
  _has_bits_[0] &= ~0x00000001u;
}
 void MsgAddOfficilMapACK::clear_map() {
  if (map_ != NULL) map_->::message::CrashMapData::Clear();
  clear_has_map();
}
 const ::message::CrashMapData& MsgAddOfficilMapACK::map() const {
  // @@protoc_insertion_point(field_get:message.MsgAddOfficilMapACK.map)
  return map_ != NULL ? *map_ : *default_instance_->map_;
}
 ::message::CrashMapData* MsgAddOfficilMapACK::mutable_map() {
  set_has_map();
  if (map_ == NULL) {
    map_ = new ::message::CrashMapData;
  }
 ...
 ::message::CrashMapData* MsgAddOfficilMapACK::release_map() {
  clear_has_map();
  ::message::CrashMapData* temp = map_;
  map_ = NULL;
  return temp;
}
 void MsgAddOfficilMapACK::set_allocated_map(::message::CrashMapData* map) {
  delete map_;
  map_ = map;
  if (map) {
    set_has_map();
