...
namespace common.Sockets
{
    ...
    public delegate void ConnectHandler(SocketBase socket);
	...
	public abstract class SocketBase : IDisposable
	{
        ...
        protected internal ConnectHandler connectHandler;
		/// <summary>
        ...
        protected internal byte[] msgBuffer;
